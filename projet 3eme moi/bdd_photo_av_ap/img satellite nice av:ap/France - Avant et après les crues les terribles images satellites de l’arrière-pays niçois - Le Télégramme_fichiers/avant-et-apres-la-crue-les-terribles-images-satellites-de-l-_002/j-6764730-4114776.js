//Generated:2022-11-09 14:19:21// 39-536
(function() {
  var o = {
    $: function(el) {
      var x = el || o.divID,
  ...
  var data = {
    params: window.ftParams_6764730 || '',
    GUID: window.ftGUID_6764730 || '99999999999',
    confID: window.ftConfID_6764730 || '0',
    ftReturn: window.ftReturn_6764730 || '',
    keyword: window.ftKeyword_6764730 || '',
    ftId: window.ftId_6764730 || '',
    imp: window.ftImp6764730,
    ftImpId: window.ftImp6764730 && window.ftImp6764730.impID || '',
    gdpr: window.ftImp6764730 && window.ftImp6764730.gdpr || '',
    gdpr_consent: window.ftImp6764730 && window.ftImp6764730.gdpr_consent || '',
    gdpr_pd: window.ftImp6764730 && window.ftImp6764730.gdpr_pd || '',
    us_privacy: window.ftImp6764730 && window.ftImp6764730.us_privacy || '',
    campaignID: '191294',
    cID: '168557',
    pID: '6764730',
    creativeID: '4114776',
    ...
    clickTags: [
      "https://servedby.flashtalking.com/click/1/191294;6764730;4114776;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=https://www.magasins-u.com/rechercher-un-magasin"
    ],
    ...
    divID: 'ftdiv6764730',
    phID: 'ftpos6764730',
    frameID: 'ftframe6764730',
    expID: 'ftexpframe6764730',
    altImgID: 'ftalt6764730',
    altText: 'Click here',
    altImgTarget: '_blank',
    altimghref: 'https://servedby.flashtalking.com/click/1/191294;6764730;4114776;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=https://www.magasins-u.com/rechercher-un-magasin',
    altImg: 'https://servedby.flashtalking.com/imp/1/191294;6764730;204;gif;Xandr;300x250/?',
    viewableImpressionURL: 'https://servedby.flashtalking.com/imp/1/191294;6764730;271;pixel;Xandr;300x250/?',
    stump: 'https://servedby.flashtalking.com',
    jsurl: 'http://cdn.flashtalking.com/xre/676/6764730/4114776/js/j-6764730-4114776.js',
    file: 'http://cdn.flashtalking.com/168557/4114776/index.html',
    safeFrame: window.$sf && window.$sf.ext || false,
    serveDOM: 'http://cdn.flashtalking.com',
    statBaseURL: 'http://stat.flashtalking.com/reportV3/ft.stat?224870168-6764730;4114776;',
    adVis: false ? 1 : 0,
    centreAd: false,
    mvt: true,
    segment: window.ftSegment_6764730 || '',
    segmentList: window.ftSegmentList_6764730 || [],
    ...
    baggyFrameLimit: 15,
    append: !!(window.ftImp6764730 && window.ftImp6764730.jsAppend),
    ...
    pageVisible: 'maybe',
    altimgborder: '0',
    secure: !!(location.protocol === 'https:' || !!(document.getElementById('ftscript_m6764730') && /^https:/.test(document.getElementById('ftscript_m6764730').src)) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc', ''))),
    scriptLocation: document.getElementById('ftscript_m6764730'),
    ...
    qsVars: [
      ['ftguid', 'ftGUID_6764730'],
      ['ftcfid', 'ftConfID_6764730'],
      ['fttime', 'ftTimestamp_6764730'],
      ['ftsection', 'ftSection_6764730'],
      ['ftcustom', 'ftCustom_6764730'],
      ['ft_id', 'ftId_6764730'],
      ['ftimpid', 'ftImp6764730', 'impID'],
      ['gdpr', 'ftImp6764730', 'gdpr'],
      ['gdpr_consent', 'ftImp6764730', 'gdpr_consent'],
      ['gdpr_pd', 'ftImp6764730', 'gdpr_pd'],
      ['us_privacy', 'ftImp6764730', 'us_privacy']
    ]
  };
